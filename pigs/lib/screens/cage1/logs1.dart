...
class C1Logs extends StatefulWidget {
  const C1Logs({Key? key}) : super(key: key);

  @override
  State<C1Logs> createState() => _C1LogsState();
}

class _C1LogsState extends State<C1Logs> {
  final _Database = FirebaseDatabase.instance.ref();

  Future<List<Log>> _getLogs() async {
    final snapshot = await FirebaseDatabase.instance.ref("cage_1/logs").get();
    final data =
