...
class BathSchedule extends StatefulWidget {
  @override
  _BathScheduleState createState() => _BathScheduleState();
}

class _BathScheduleState extends State<BathSchedule> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("BATH SCHEDULE"),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
  ...
  Future<void> postUpdated_C1(String time) async {
    DatabaseReference _testRef =
        FirebaseDatabase.instance.ref("/cage1_bath_sched");
  ...
  Future<void> postUpdated_C2(String time) async {
    DatabaseReference _testRef =
        FirebaseDatabase.instance.ref("/cage2_bath_sched");
